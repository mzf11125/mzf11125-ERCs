...
This ERC requires [ERC-7812](./eip-7812.md) (Review) and [ERC-8004](./eip-8004.md), both recent. A Standards Track ERC MAY sit in Draft or Review atop pre-Final dependencies, but it cannot advance to Final until they do. Integrators SHOULD pin the exact versions of the dependencies they rely on.
