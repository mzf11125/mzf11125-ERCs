...
A blinded commitment is confidential *and* not auditable, which is a worse trade than preimage resistance alone. The unblinded commitment is what enables selective disclosure to auditors (see Security Considerations).
...
### Writing VerdictAttestation to the Validation Registry
